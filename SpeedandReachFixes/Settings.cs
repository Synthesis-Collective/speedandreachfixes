...
namespace SpeedandReachFixes
{
    ...
    public class GameSettings
    {
        ...
        public bool WeaponSwingAngleChanges = false;
    ...
    public class WeaponStats
    {
        ...
        [SettingName("Modifier"), Tooltip("When checked, adds the specified values rather than overwriting them.")]
        public bool IsModifier;
        
        [Tooltip("The keyword attached to this weapon type.")]
        private FormLink<IKeywordGetter> _keyword;
        ...
        {
            if ((keywords != null) && (_keyword != null!) && keywords.Any(kywd => _keyword.Equals(kywd)))
                return Priority;
        ...
        public bool IsNull()
        {
            return (_keyword == null!) || Reach.Equals(Constants.DefaultPriority) && Speed.Equals(Constants.DefaultPriority);
        }
    }
